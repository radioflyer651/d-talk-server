...
export interface IPluginResolver {
    ...
    getPluginInstance(pluginInstance: PluginInstanceReference, attachmentTarget: PluginAttachmentTargetTypes): Promise<AgentPluginBase | undefined>;

    /** Given a set of PluginInstanceReference objects, returns all plugins for those objects. */
    getPluginInstances(pluginReferences: PluginInstanceReference[], attachmentTarget: PluginAttachmentTargetTypes): Promise<AgentPluginBase[]>;
