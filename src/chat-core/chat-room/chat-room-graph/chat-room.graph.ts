...
export function createChatRoomGraph() {
    ...
    graph.addNode('chat-start', nodes.startChatCall)
        ...
        .addNode('inspect-chat-call-messages', nodes.inspectChatCallMessages)
        ...
        .addEdge('add-pre-chat-messages', 'inspect-chat-call-messages')
        .addEdge('inspect-chat-call-messages', 'chat-call')
